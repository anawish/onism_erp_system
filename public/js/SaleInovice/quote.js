$(document).ready(function(){
    ...
    $("#addrow").on("click", function () {
        ...
        cols += '<td><div class="input-group"><input type="text" class="form-control form-control-sm product_name" required="" id="product_name" name="product_name[]" onkeypress="SearchProduct(this)"/><input type="hidden" name="product_id[]" id="product_id" class="product_id"><div class="input-group-prepend"><div class="input-group-text" style="height: 31px;"><i class="fa fa-search-plus searchbtn" data-toggle="modal" data-target="#searchitem" onclick="searchbtn(this)"></i></div></div></div><ul class="product_det"></ul></td>';
        cols += '<td><input type="text" class="form-control form-control-sm qty" id="qty" onchange="qty_calculate(this)" required=""name="qty[]"/></td>';
        cols += '<td><input type="text" class="form-control form-control-sm price" id="price" required="" name="price[]"/></td>';
        cols += '<td><select class="form-control form-control-sm price_type" name="price_type[]" id=price_type""><option>Retail</option><option>Wholesale</option></select></td>';
        cols += '<td><input type="text" class="form-control form-control-sm tax_rate" id="tax_rate" name="tax_rate[]"onchange="qty_calculate(this)" value="0"/></td>';
        ...
        cols += '<td><input type="text" class="form-control form-control-sm totalAmount" required="" id="totalAmount" readonly name="totalAmount[]"/></td>';
        cols += '<td><input type="button" class="delete_row form-control-sm btn btn-md btn-danger" value="X"></td>';
        newRow.append(cols);
