...
<head>
    ...
    <title>Print Quote Invoice</title>
    <style>	
        body {
            color: #2B2000;
	...
	<table>
		<tr>
			...
			<td colspan="6">
				...
				<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span>Quote No </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>QI  #  {{$data['invoice_no']}}</span>
				<br>
				<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span>Quote Date</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>{{$data['invoicedate']}}</span>
				<br>
	...
	<table class="table table-bordered">
		...
		<tbody>
			...
			<tr>
				@foreach($SupplierDetail as $detail)
				<td colspan="3">
					<span>Total Amount :</span>  <strong>${{$detail->total}}</strong>
				</td>
				<td colspan="3">Total Discount</td>
				<td colspan="3">${{$detail->total_discount}}</td>
				@endforeach
			</tr>
			<tr>
				@foreach($SupplierDetail as $detail)
				...
				<td colspan="3"><strong>${{$detail->total_tax}}</strong></td>
				@endforeach
			</tr>
			<!-- <tr>
				@foreach($SupplierDetail as $detail)
