	                ...
	                <div id="invoice-template" class="card-block">
	                    <div class="row wrapper white-bg page-heading">
	                        <div class="col-lg-12" style="margin-left: 30px;margin-top: 15px;">
	                            <div class="title-action">
	                                ...
	                                <div class="btn-group">
	                                    <a href="{{route('order.edit',$data['id'])}}" class="btn btn-success btn-sm">
	                                    	<i class="fa fa-print" aria-hidden="true"></i> Print Order
	                                    </a>
	                                </div>
	                                <a href="{{url('orderpreview',$data['id'])}}" class="btn btn-info btn-sm"><i class="fa fa-firefox" aria-hidden="true"></i> Preview </a>
	                    ...
	                    <div id="invoice-company-details" class="row mt-2">
	                        ...
	                        <div class="col-md-6 col-sm-12 text-xs-center text-md-right">
	                            ...
	                            <h2 class="_quote">Sale Order</h2>
	                            <p class="pb-1 _quote"> SO No # {{ $details->order_no }}</p>
	                            <p class="pb-1 _quote">P.O NO: # {{$details->po_no}}</p>
	                            @endforeach
	                            <ul class="px-0 list-unstyled _quote">
	                                <li>Gross Amount</li>
	                                <li class="font-weight-bold">
	                                $ {{number_format($data['total'],2)}}</li>
	                            </ul>
	                        </div>
	                    </div>
	                    <!--/ Invoice Company Details -->
	                    ...
	                    <div id="invoice-customer-details" class="row pt-2">
	                        ...
	                        <div class="offset-md-3 col-md-3 col-sm-12 text-xs-center text-md-left">
	                            ...
	                            <p><span class="text-muted">Due Date :</span> {{$details->delivery_date}} </p> 
	                            @endforeach
	                        </div>
	                    </div>
	                    ...
	                    <div id="invoice-items-details" class="pt-2">
	                        ...
	                        <div class="row">
	                            <div class="col-md-7 col-sm-12 text-xs-center text-md-left">
	                                <div class="row">
	                                    <div class="col-md-8">
	                                        <p class="lead mt-1"><br> Sale Order Note: {{$data['order_note']}}</p>
	                                    </div>
	                                </div>
	                            </div>
