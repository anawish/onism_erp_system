...
<body style="background-color: #e8e4e4!important;">
	...
	<div class="card border-0">
		<div class="row">
			...
			<div class="col-md-6">
				<a href="{{route('quoteinvoice.edit',$data['id'])}}" class="btn btn-info btn-sm float-right print_btn">
					<i class="fa fa-print" aria-hidden="true"></i>  Print Quote</a>
			</div>
		</div>
		<hr>
		...
		<div class="row">
			...
			<div class="col-md-6 float-right">
				<h2 class="float-right mr-25">Quotation</h2>
				<br><br>
				<p class="float-right mr-25"> QI # {{$data['invoice_no']}}</p>
				<br><br>
		...
		<div id="invoice-customer-details ">
            <div class="row pt-2">
                ...
                <div class="col-md-3 col-sm-12 text-xs-center text-md-left">
                    <p><span class="text-muted">Purchasing Date :</span> {{$data['invoicedate']}}</p> 
                    <p><span class="text-muted">Due Date :</span> {{$data['invoice_duedate']}}</p>  
                </div>
            </div>
        </div>
		<!-- /Invoice Customer Details -->
		...
		<div id="invoice-items-details" class="pt-2">
            ...
            <div class="row">
                <div class="col-md-7 col-sm-12 text-xs-center text-md-left">
                    <div class="row">
                        <div class="col-md-8">
                            <p class="lead mt-1 ml-20"><br> Quote Note: {{$data['invoice_note']}}</p>
                            <p class="lead mt-1 ml-20"> Quote Proposal: {{$data['invoice_note']}}</p>
