...
<body style="background-color: #e8e4e4!important;">
	...
	<div class="card border-0">
		<div class="row">
			...
			<div class="col-md-6">
				<a href="{{route('printinvoice.show',$data['id'])}}" class="btn btn-info btn-sm float-right print_btn">
		...
		<div class="row">
			...
			<div class="col-md-6 float-right">
				<h2 class="float-right mr-25">INVOICE</h2>
				<br><br>
				...
				<ul class="px-0 list-unstyled float-right">
                    ...
                    <li class="mr-25 _font-w-600">$ {{number_format($data['grand_total'],2)}}</li>
                </ul>
			</div>
		</div>
		<!--/ Invoice Company Details -->
                ...
                <div class="col-md-7 col-sm-12 text-xs-center text-md-left">
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <p class="lead ml-20">Payment Method: <u><strong id="pmethod">{{$data['pmethod']}}</strong></u>
                            </p>
                            ...
                            <tbody>
	                            ...
	                            <tr>
	                                ...
	                                <td class="pink text-xs-right">
	                                    (-)  <span id="paymade">{{number_format($data['payment'],2)}} </span></td>
		                            </tr>
