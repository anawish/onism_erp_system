		...
		<div class="row">
			...
			<div class="col-md-9">
					...
					<div class="col-md-3">
						<a href="{{url('/products')}}" style="text-decoration: none;">
							<div class="card _card">
				                <div class="card-body _card_body">
					                <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center card_content">
					                    <h6 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0 content_color" style="font-weight: 600;font-size: 19px;">Products Manage</h6>
					                    <i class="ti-calendar icon-md text-muted mb-0 mb-md-3 mb-xl-0 mt-25">
					                    	<img src="{{asset('image/sale-icon/1.png')}}">
					                    </i>
					                </div> 
				...
				<div class="row mt-20">
							...
							<div class="card _card">
				                <div class="card-body _card_body">
					                <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center card_content">
					                    ...
					                    <i class="ti-calendar icon-md text-muted mb-0 mb-md-3 mb-xl-0 mt-25 stockreturn" style="">
					...
					<div class="col-md-3">
						<a href="{{url('/grn')}}" style="text-decoration: none;">
							<div class="card _card">
				                <div class="card-body _card_body">
					                <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center card_content">
					                    <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0 content_color">Goods Receive <br>Note (GRN)</h3>
					                    <i class="ti-calendar icon-md text-muted mb-0 mb-md-3 mb-xl-0 mt-20">
					                    	<img src="{{asset('image/sale-icon/4.png')}}">
					                    </i>
					                </div> 
					...
					<div class="col-md-3">
						<a href="{{url('/grnprint/show')}}" style="text-decoration: none;">
							<div class="card _card">
				                <div class="card-body _card_body">
					                <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center card_content">
					                    <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0 content_color">Manage (GRN)</h3>
					                    <i class="ti-calendar icon-md text-muted mb-0 mb-md-3 mb-xl-0 mt-20">
					                    	<img src="{{asset('image/sale-icon/4.png')}}">
					                    </i>
					                </div> 
