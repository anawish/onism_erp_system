...
<body>
	<table>
		<tr>
			...
			<td colspan="6">
				<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span>GRN Number :</span>&nbsp;&nbsp;&nbsp;<span>{{$data['grn_no']}}</span>
		...
		<tbody>
			<tr>
				<td colspan="6">
					...
					<span style="text-decoration: underline;">{{$data['doc_date']}}</span>
				</td>
				<td colspan="6">
					<span>Posting Date :</span><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					</span> <span style="text-decoration: underline;">{{$data['posting_date']}}</span>
				</td>
	...
	<table class="table table-bordered">
		...
		<tbody>
			...
			<tr class="autonumber">
				...
				<td>{{$products['order_qty']}}</td>
				<td>{{$products['receive_qty']}}</td>
				<td>{{$products['unit']}}</td>
