...
class CreateItemController extends Controller
{
    ...
    public function index()
    {
        ...
        $warehouse = DB::table('zenrolle_warehouse')->select('id','warehouse_name')->get();
          return view('inventory.add_product.createitem',compact('warehouse','data'));
    ...
    public function edit($id)
    {
        ...
        return view('inventory.add_product.editproduct',compact('edit_pro','data','warehouse'));
    }
    ...
    {
        $UpdateProduct = CreateItem::findOrFail($id);
